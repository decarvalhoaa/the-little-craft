...
if ( $terms_page_id > 0 && apply_filters( 'woocommerce_checkout_show_terms', true ) ) :
	...
	<p class="form-row terms wc-terms-and-conditions">
		<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
			...
			-->
			<input type="checkbox" class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox" name="terms" <?php checked( apply_filters( 'woocommerce_terms_is_checked_default', isset( $_POST['terms'] ) ), true ); ?> id="terms" /> <span><?php printf( __( 'I&rsquo;ve read and accept the <a href="%s" target="_blank">Terms &amp; Conditions</a> and <a href="%s" target="_blank">Privacy Policy</a>', 'thelittlecraft' ), esc_url( wc_get_page_permalink( 'terms' ) ), esc_url( tlc_pll_get_permalink( 210 ) ) ); ?></span> <span class="required">*</span>
		</label>
